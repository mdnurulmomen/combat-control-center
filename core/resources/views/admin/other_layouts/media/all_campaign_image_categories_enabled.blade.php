                                                ...
                                                <form method="POST" action = "{{ route('admin.updated_campaign_image_category_submit', $campaignImageCategory->id) }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-row mb-4">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input class="form-control is-valid" type="text" name="name" placeholder="Enter Category name" required="true" value="{{$campaignImageCategory->name}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row mb-4">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control is-valid" type="number" name="width" placeholder="Enter Image Width" required="true" value="{{$campaignImageCategory->width_size}}" min="1">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="validationServer01">Height Size</label>
                                                            <input class="form-control is-valid" type="number" name="height" placeholder="Enter Image Height" required="true" value="{{$campaignImageCategory->height_size}}" min="1">
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action = "{{ route('admin.created_campaign_image_category_submit') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-row mb-4">
                                    <div class="col-md-12">
                                        <label for="validationServer01">Name</label>
                                        <input class="form-control is-valid" type="text" name="name" placeholder="Enter Category name" required="true">
                                    </div>
                                </div>
                                ...
                                <div class="form-row mb-4">
                                    <div class="col-md-6">
                                        <label for="validationServer01">Width Size</label>
                                        <input class="form-control is-valid" type="number" name="width" placeholder="Enter Image Width" required="true" min="1">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="validationServer01">Height Size</label>
                                        <input class="form-control is-valid" type="number" name="height" placeholder="Enter Image Height" required="true" min="1">
                                    </div>
                                </div>
