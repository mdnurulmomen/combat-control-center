...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{ asset('assets/admin/images/profile/'.optional(\Illuminate\Support\Facades\Auth::guard('admin')->user())->picture) }}" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">
            {{ optional(\Illuminate\Support\Facades\Auth::guard('admin')->user())->username}}
          </p>
    ...
    <main class="app-content">  
      ...
      <div class="content p-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action = "{{ route('admin.updated_quit_submit') }}">
